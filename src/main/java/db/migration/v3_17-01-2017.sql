...
ALTER TABLE public.usuario OWNER TO cwcdcomb_cwc3d;
...
ALTER TABLE public.usuario_id_seq OWNER TO cwcdcomb_cwc3d;
...
ALTER TABLE public.usuarioacesso OWNER TO cwcdcomb_cwc3d;
